...
**Путь:** /conv/getdialogtransactions/
...
**Путь:** /conv/getgrouptransactions/

**Параметр:** groupID – ID группы <br>
**Параметр:** transactionID <br>
**Выходные данные:** Transaction[20] + DefaultClass

#### Метод для получения прошлых транзакций, когда пришло новое сообщение в диалоге
...
#### Метод для получения прошлых транзакций, когда пришло новое сообщение в группе
**Путь:** /conv/getnewtransactions/
...
//И сразу перемещаемся в окно диалога
...
**Путь:** /group/delete/  или /group/leave/
